...
public class RateLimitingProcessor implements Processor {
     ...
     */
    @Override
    public void processLogEvents(List<AppLoadBalancerLogEvent> events, RateLimitConfig config, String bucketName) {
    ...
    private void logSummary(Map<String, List<String>> summary, RateLimitConfig config) {
     ...
     */
    protected RangeSet<Integer> getDoNotBlockRangeSet(RateLimitConfig config) {
     ...
     */
    protected Map<String, ViolationMetaData> filterAndTruncateViolators(RateLimitConfig params,
     ...
     */
    protected Map<String, List<String>> processViolators(RateLimitConfig config, Map<String, ViolationMetaData> violators) {
     ...
     */
    protected void processRequest(AppLoadBalancerLogEvent event, Map<String, Integer> reqIdCountMap) {
     ...
     */
    protected Map<String, ViolationMetaData> getCurrentViolators(Map<String, Integer> reqIdCountMap, RateLimitConfig params) {
        Date now = new Date();
