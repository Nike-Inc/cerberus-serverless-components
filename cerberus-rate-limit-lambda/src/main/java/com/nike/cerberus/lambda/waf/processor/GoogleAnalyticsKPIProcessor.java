...
public class GoogleAnalyticsKPIProcessor implements Processor {
     ...
     */
    protected void processLogEvents(List<AppLoadBalancerLogEvent> events, GAWrapper tracker) {
     ...
     */
    private void trackSDBCreated(AppLoadBalancerLogEvent event) {
     ...
     */
    private void trackSDBEvent(AppLoadBalancerLogEvent event) {
        String eventCategory = "cms";
        String path = event.getRequestUri();
     ...
     */
    private void trackSDBNodeEvent(AppLoadBalancerLogEvent event) {
        String path = event.getRequestUri();
        String[] parts = path.split("/");
     ...
     */
    private void trackIAMAuth(AppLoadBalancerLogEvent event) {
        String eventCategory = "cms";
     ...
     */
    private void trackUserAuth(AppLoadBalancerLogEvent event) {
        String eventCategory = "cms";
     ...
     * Track bad requests.
     */
    private void trackBadRequest(AppLoadBalancerLogEvent event) {
     ...
     * Track server errors.
     */
    private void trackServerError(AppLoadBalancerLogEvent event) {
        String eventCategory = "error";
     ...
     */
    private void trackUnknownStatus(AppLoadBalancerLogEvent event) {
        String eventCategory = "error";
